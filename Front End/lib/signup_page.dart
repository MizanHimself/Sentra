                  ...
                  child: Center(
                    child: Container(
                      padding: const EdgeInsets.all(
                          32.0), // Add padding to the container
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: [
                              Checkbox(
                                value:
                                    _agreeToUserAgreement, // Bind the checkbox state
                                onChanged: (value) {
                                  setState(() {
                              ...
                              const Text(
                                  'I agree to the User Agreement'), // Display the checkbox label
                            ],
                          ),
                          Row(
                            children: [
                              Checkbox(
                                value:
                                    _receiveNewsletter, // Bind the checkbox state
                                onChanged: (value) {
                                  setState(() {
                                    _receiveNewsletter =
                                        value!; // Update the checkbox state
                              ...
                              const Text(
                                  'Receive Newsletter'), // Display the checkbox label
                            ],
                          ),
                          const SizedBox(height: 40), // Add vertical spacing
                          ElevatedButton(
                          ...
                          Align(
                            alignment:
                                Alignment.center, // Center the text button
                            child: TextButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                              ...
                              child: const Text(
                                ...
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors
                                        .blue), // Set text button text style
                              ),
                            ),
                          ),
                        ],
